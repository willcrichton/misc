...
(() => {
  ...
  function getSessionId() {
    ...
    if (localStorage.getItem(SESSION_STORAGE_KEY) === null) {
      localStorage.setItem(SESSION_STORAGE_KEY, v4_default());
    }
  ...
  var Telemetry = class {
    ...
    log(endpoint, payload) {
      ...
      import_axios.default.post(fullUrl, log);
    }
  };
  if (typeof window !== "undefined") {
    window.telemetry = new Telemetry("https://rust-book.willcrichton.net/logs", "4d70973d9957e717b0287aec09fc7727d2aea173", "ownership-chapter");
  }
})();
